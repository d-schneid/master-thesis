...
if __name__ == '__main__':
	num_train_samples = 90_000
	num_test_samples = 5_000
	task = CodeCompletion()
	dataset = NotBadAi(task=task, split='test')
	data = dataset.load_dataset().select(range(num_train_samples, num_train_samples + num_test_samples))

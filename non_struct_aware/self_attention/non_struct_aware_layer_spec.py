...
from non_struct_aware.self_attention.non_struct_aware_self_attention import NonStructAwareSelfAttention
from non_struct_aware.transformer.non_struct_aware_transformer_layer import NonStructAwareTransformerLayer
...
def get_gpt_layer_with_transformer_engine_spec(
	...
	return ModuleSpec(
		module=NonStructAwareTransformerLayer,
		submodules=TransformerLayerSubmodules(
			self_attention=ModuleSpec(
				module=NonStructAwareSelfAttention,
...
def non_struct_aware_layer_spec(config: "GPTConfig") -> ModuleSpec:
	if HAVE_TE:

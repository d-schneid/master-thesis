...
from non_struct_aware.transformer.non_struct_aware_transformer_block import NonStructAwareTransformerBlock


class NonStructAwareMCoreGPTModel(MCoreGPTModel):
	...
	def __init__(
		...
		# Non-structure-aware Transformer.
		self.decoder = NonStructAwareTransformerBlock(
			config=self.config,
	...
	def forward(
		...
		if decoder_input is not None:
			...
			decoder_input = code_text_token_embedding
		else:

...
class NonStructAwareStarcoder2Model(Starcoder2Model):
...
class HFStructureAwareStarcoder2Importer(io.ModelConnector["Starcoder2ForCausalLM", NonStructAwareStarcoder2Model]):

	def init(self) -> NonStructAwareStarcoder2Model:
		return NonStructAwareStarcoder2Model(self.config, tokenizer=self.tokenizer)
	...
	def apply(self, output_path: Path) -> Path:
		...
		print(f"Converted NonStructAwareStarcoder2 model to Nemo, model saved to {output_path}")
	...
	@property
	def config(self) -> NonStructAwareStarcoder2Config:
		...
		output = NonStructAwareStarcoder2Config(
